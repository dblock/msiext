namespace AppSecInc.Wix.Extensions
{
    ...
    /// <summary>
    /// A wix extension for SystemTools custom action library.
    /// </summary>
    public sealed class SystemToolsExtension : WixExtension
    {
        private Library library;
        private SystemToolsCompiler compilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new SystemToolsCompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "AppSecInc.Wix.Extensions.Data.SystemTools.wixlib", tableDefinitions);
            }
