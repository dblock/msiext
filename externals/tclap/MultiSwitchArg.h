...
std::wstring MultiSwitchArg::shortID(const std::wstring& val) const
{
	std::wstring id = Arg::shortID() + _T(" ... ");

	return id;
}

std::wstring MultiSwitchArg::longID(const std::wstring& val) const
{
	std::wstring id = Arg::longID() + _T("  (accepted multiple times)");
