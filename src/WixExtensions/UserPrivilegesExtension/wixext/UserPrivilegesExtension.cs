namespace AppSecInc.Wix.Extensions
{
    ...
    /// <summary>
    /// A wix extension for UserPrivileges custom action library. 
    /// See \ref Wix::Extensions::UserPrivileges for more information.
    /// </summary>
    public sealed class UserPrivilegesExtension : WixExtension
    {
        private Library library;
        private UserPrivilegesCompiler compilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new UserPrivilegesCompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "AppSecInc.Wix.Extensions.Data.UserPrivileges.wixlib", tableDefinitions);
            }
