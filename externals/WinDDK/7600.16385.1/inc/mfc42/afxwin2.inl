...
_AFXWIN_INLINE int CEdit::GetLine(
        __in int nIndex, 
        __inout
        ...
        { ASSERT(::IsWindow(m_hWnd)); return (int)::SendMessage(m_hWnd, EM_GETLINE, nIndex, (LPARAM)lpBuffer); }
_AFXWIN_INLINE int CEdit::GetLine(
        __in int nIndex, 
        ...
        __in int nMaxLength) const
        {
                ...
                *(LPWORD)lpBuffer = (WORD)nMaxLength;
                return (int)::SendMessage(m_hWnd, EM_GETLINE, nIndex, (LPARAM)lpBuffer);
        }
