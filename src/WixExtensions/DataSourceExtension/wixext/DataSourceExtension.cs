namespace AppSecInc.Wix.Extensions
{
    ...
    /// <summary>
    /// A wix extension for the DataSource custom action library.
    /// See \ref DataSource for more information.
    /// </example>
    public sealed class DataSourceExtension : WixExtension
    {
        private Library library;
        private DataSourceCompiler compilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new DataSourceCompiler();
                }
